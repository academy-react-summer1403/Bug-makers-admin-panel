...
var e = class extends import_react.PureComponent {
  ...
  l() {
    ...
    const n2 = typeof t2 === "function" ? t2(this.t, i2) : t2;
    return n2;
  }
};
function r(t2) {
  var i2;
  return i2 = class extends e {
  }, i2.defaultProps = { ability: t2 }, i2;
}
function o(t2) {
...
function useAbility(i2) {
  if (typeof import_react.default.useContext !== "function") throw new Error("You must use React >= 16.8 in order to use useAbility()");
