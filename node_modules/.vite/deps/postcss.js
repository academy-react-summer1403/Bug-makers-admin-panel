...
var maxInt, base, tMin, tMax, skew, damp, initialBias, initialN, delimiter, regexNonASCII, regexSeparators, errors, baseMinusTMin, floor, stringFromCharCode, digitToBasic, adapt, encode, toASCII;
...
function parse(self, url, parseQueryString, slashesDenoteHost) {
  ...
  if (!slashesDenoteHost && url.split("#").length === 1) {
    ...
    if (simplePath) {
      ...
      if (simplePath[2]) {
        ...
        if (parseQueryString) {
          self.query = (0, import_querystring.parse)(self.search.substr(1));
        } else {
  ...
  if (qm !== -1) {
    ...
    if (parseQueryString) {
      self.query = (0, import_querystring.parse)(self.query);
    }
...
function format(self) {
  ...
  if (self.query && isObject(self.query) && Object.keys(self.query).length) {
    query = (0, import_querystring.stringify)(self.query);
  }
...
var import_querystring, url_default, protocolPattern, portPattern, simplePathPattern, delims, unwise, autoEscape, nonHostChars, hostEndingChars, hostnameMaxLen, hostnamePartPattern, hostnamePartStart, unsafeProtocol, hostlessProtocol, slashedProtocol;
var init_url = __esm({
  "node_modules/rollup-plugin-node-polyfills/polyfills/url.js"() {
    init_process();
    init_buffer();
    ...
    var PreviousMap = class {
      ...
      loadMap(file, prev) {
        ...
        if (prev) {
          ...
          if (file) map2 = join(dirname(file), map2);
